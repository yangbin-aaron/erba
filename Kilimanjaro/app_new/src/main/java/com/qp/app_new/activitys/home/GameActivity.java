...
public class GameActivity extends BaseActivity implements HallLotteryAdapter.OnItemClickListenerRaelTime, HallLotteryAdapter
    ...
    public void initView () {
        ...
        final String[] popList = {getString (R.string.hall_paying_method), getString (R.string.curr_odds), getString (R.string.revenue_bar_base)};
        mPopupWindow = DialogHelp.createPopupWindow (this, popList, new PopupWindowItemListener () {
            ...
            public void onPopItemClick (View v, int position) {
                switch (position) {
                    case 0:
                        ActivityStartUtils.startPayingMethodActivity1 (GameActivity.this, mGameJSONObject);
                        break;
                    case 1:
                        ActivityStartUtils.startActualOddsActivity (GameActivity.this, mGameJSONObject);
                        break;
                    case 2:
                        ActivityStartUtils.startRevenueActivity (GameActivity.this, mGameJSONObject);
                        break;
                }
