...
public class GameActivity extends BaseActivity implements HallLotteryAdapter.OnItemClickListenerRaelTime, HallLotteryAdapter.OnItemClickListenerHistory {
    @Override
    ...
    private void getHistoryLotteryList() {
        ...
        NetWorkManager.getInstance().getHistoryLotteryList(StringUtil.getJson(hashMap), new NetListener() {
            @Override
