...
public class ScreenUtil {
    ...
    public static int getFontSize(float textSize) {
        ...
        WindowManager windowManager = (WindowManager) App.mContext.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getScreenW() {
        DisplayMetrics dm = App.mContext.getResources().getDisplayMetrics();
