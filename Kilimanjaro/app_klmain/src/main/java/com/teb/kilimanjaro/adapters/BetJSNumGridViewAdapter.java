 ...
 */
public class BetJSNumGridViewAdapter extends BaseAdapter {

    private List<OddsListModel.OddsData> mOddsDataList;
    private LayoutInflater mInflater;

    public BetJSNumGridViewAdapter() {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (!data.isSelected()) {
            ...
            holder.tv_num.setTextColor(App.getAppContext().getResources().getColor(R.color.main_background));
        } else {
